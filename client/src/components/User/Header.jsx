      ...
      <nav class="relative px-2 bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 flex">
        ...
        <div class="flex items-center">
          ...
          >
            ...
            <img class="w-12 h-8 rounded-full" src="/img/profile-default.png" alt="user photo" />
          </button>

          <div
            class={"absolute top-14 right-16 z-50 block my-4 text-base list-none divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600 bg-yellow-300 " + (profileHS ? " block" : "hidden")}
            id="user-dropdown"
          >
            <div class="px-4 py-3">
